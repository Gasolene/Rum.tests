        ...
        DatePicker = function( $element, options ) {
            ...
            P = Picker.prototype = {
                ...
                init: function( $element, options ) {
                    ...
                    DATE_SELECTED = P.getDateSelected( SETTINGS.date_selected )
                 ...
                 */
                getDateSelected: function( date_selected ) {
					//issue found with prepopulated dates of the format (YYYY-mm-dd), override by allowing
					//passage of array( 'YYYY', 'MM', 'DD') on init
					if ( date_selected ) return createDate(date_selected) ;
